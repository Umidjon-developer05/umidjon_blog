...
import AboutPNG1 from "@/public/about/01.jpg";
import AboutPNG2 from "@/public/about/02.jpg";
import AboutPNG3 from "@/public/about/00.jpg";
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <h1 className="text-center text-4xl font-creteRound">
        We are the Umidjon, <br /> Team of content writers and designers.
      </h1>
